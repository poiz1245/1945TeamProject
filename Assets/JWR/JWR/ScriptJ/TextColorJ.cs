...
public class TextColorJ : MonoBehaviour
{
    [SerializeField]
    float lerpTime = 0.1f;
    TextMeshProUGUI BossWarning;
    ...
    {
        //캐싱
        BossWarning = GetComponent<TextMeshProUGUI>();
    ...
    IEnumerator ColorLerp(Color startColor, Color endColor)
    {
        ...
        while (percent < 1)
        {
            ...
            BossWarning.color = Color.Lerp(startColor, endColor, percent);
